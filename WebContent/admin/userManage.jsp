...
<script type="text/javascript">
	...
	function searchUser(){
		$("#dg").datagrid('load',{
			"s_user.userName" : $("#s_userName").val().trim()
		});
	}
	...
	function deleteUser(){
		...
		var ids = strIds.join(","); //[1,2,3] -> 1,2,3;
...
<body style="margin: 1px;">
	<table id="dg" class="easyui-datagrid" title="用户管理" fitColumns="true" url="user_list.action" pagination="true" rownumbers="true" fit="true" toolbar="#tb">
		<thead>
			<tr>
		...
		<form id="fm" method="post">
			<table cellspacing="8px">
				...
				<tr>
					...
					<td>性别：</td>
					<td>
						<select class="easyui-combobox" id="sex" name="user.sex" style="width: 127px;" editable="false" panelHeight="auto">
