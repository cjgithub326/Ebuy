...
<script type="text/javascript">
 ...
 function searchNotice(){
	 $("#dg").datagrid('load',{
		 "notice.title":$("#noticeTitle").val().trim()
	 });
 }
...
<body style="margin: 1px;">
	...
	<div id="tb">
		...
		<div>
			&nbsp;公告名称：&nbsp;<input type="text" id="noticeTitle" size="20" onkeydown="if(event.keyCode==13) searchNotice()"/>
	...
	<div id="dlg" class="easyui-dialog" style="width: 750px;height: 450px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px">
				<tr>
				 	<td>公告标题：</td>
				 	<td colspan="4"><input type="text" id="title" name="notice.title" class="easyui-validatebox" required="true" style="width: 325px"/></td>
				</tr>
				<tr>
				 	<td valign="top">公告内容：</td>
				 	<td colspan="4">
				 		<textarea id="content" name="notice.content" class="ckeditor"></textarea>
				 		<input type="hidden" id="createTime" name="notice.createTime"></input>
				 	</td>
				</tr>
			</table>
		</form>
