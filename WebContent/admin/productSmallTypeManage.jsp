...
<script type="text/javascript">
 ...
 function searchProductSmallType(){
	 $("#dg").datagrid('load',{
		 "productSmallType.name":$("#productSmallTypeName").val().trim()
	 });
 }
 ...
 function openProductSmallTypeModifyDialog(){
	var selectedRows = $("#dg").datagrid('getSelections');
		...
		url = "productSmallType_save.action?s_productSmallType.id=" + row.id;
	}
	//删除商品小类 
...
<body style="margin: 1px;">
	<table id="dg" class="easyui-datagrid" title="商品小类管理" fitColumns="true" url="productSmallType_list.action" pagination="true" rownumbers="true" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;商品小类名称：&nbsp;<input type="text" id="productSmallTypeName" size="20" onkeydown="if(event.keyCode==13) searchProductSmallType()"/>
		...
		<form id="fm" method="post">
			<table cellspacing="8px">
				<tr>
					<td>所属大类：</td>
					<td colspan="4">
						<input class="easyui-combobox" id="bName" name="s_productSmallType.bigType.id" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name',url:'productBigType_comboList.action'"/>
					</td>
				</tr>
				<tr>
				 	<td>商品小类名称：</td>
				 	<td colspan="4"><input type="text" id="name" name="s_productSmallType.name" class="easyui-validatebox" required="true" style="width: 325px"/></td>
				</tr>
				<tr>
				 	<td valign="top">备注：</td>
				 	<td colspan="4"><textarea rows="8" cols="50" id="remarks" name="s_productSmallType.remarks"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
