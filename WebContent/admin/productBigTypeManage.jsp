...
<script type="text/javascript">
 ...
 function searchProductBigType(){
	 $("#dg").datagrid('load',{
		 "productBigType.name":$("#productBigTypeName").val().trim()
	 });
 }
 ...
 function openProductBigTypeModifyDialog(){
		...
		url="productBigType_save.action?s_productBigType.id="+row.id;
 }
 //删除商品大类 
...
<body style="margin: 1px;">
	<table id="dg" class="easyui-datagrid" title="商品大类管理" fitColumns="true" url="productBigType_list.action" pagination="true" rownumbers="true" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;商品大类名称：&nbsp;<input type="text" id="productBigTypeName" size="20" onkeydown="if(event.keyCode==13) searchProductBigType()"/>
	...
	<div id="dlg" class="easyui-dialog" style="width: 600px;height: 300px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="8px">
				<tr>
				 	<td>商品大类名称：</td>
				 	<td colspan="4"><input type="text" id="name" name="s_productBigType.name" class="easyui-validatebox" required="true" style="width: 325px"/></td>
				</tr>
				<tr>
				 	<td valign="top">备注：</td>
				 	<td colspan="4"><textarea rows="8" cols="50" id="remarks" name="s_productBigType.remarks"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
