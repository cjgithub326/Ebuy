			...
			<form action="comment_save.action" method="post" onsubmit="return checkForm()">
				<table>
					<tr>
						...
						<td><input type="text" class="text" id="nickName" name="commentSave.nickName"/></td>
					</tr>
					<tr>
						<td class="field">留言内容：</td>
						<td><textarea id="content" name="commentSave.content"></textarea></td>
					</tr>
					<tr>
						<td></td>
						<td><label class="ui-blue"><input type="submit" name="submit" value="提交留言"/></label>&nbsp;&nbsp;<font id="error" color="red">${error }</font>
						</td>
					</tr>
				</table>
			</form>
